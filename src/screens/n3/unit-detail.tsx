    ...
    <ScrollView className="flex-1 bg-slate-100 dark:bg-slate-950" contentContainerClassName="gap-4 px-5 pb-5 pt-10">
      <View className="flex-row flex-wrap items-center gap-1 pt-10">
        ...
        <Pressable onPress={() => router.push('/n3' as any)}>
          <Text className="text-base font-semibold text-sakura-700">All Units</Text>
        </Pressable>
        <Text className="text-base text-slate-500">›</Text>
        <Text className="text-base font-semibold text-slate-700 dark:text-slate-300">Unit {unit.unitNumber}</Text>
      </View>
