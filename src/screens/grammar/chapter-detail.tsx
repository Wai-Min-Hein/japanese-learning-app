    ...
    return (
      <View className="flex-1 items-center justify-center bg-slate-100 p-5 dark:bg-slate-950">
        ...
        <Pressable className="mt-3" onPress={() => router.push('/grammar')}>
          <Text className="font-semibold text-sakura-700">Grammar Chapters</Text>
        </Pressable>
      </View>
    );
  }
    ...
    <ScrollView className="flex-1 bg-slate-100 dark:bg-slate-950" contentContainerClassName="gap-4 px-5 pb-5 pt-10">
      <View className="flex-row flex-wrap items-center gap-1 pt-10">
        ...
        <Pressable onPress={() => router.push('/grammar')}>
          <Text className="text-base font-semibold text-sakura-700">Grammar</Text>
        </Pressable>
        <Text className="text-base text-slate-500">›</Text>
        <Text className="text-base font-semibold text-slate-700 dark:text-slate-300">{chapter.title}</Text>
      </View>
